...
protected:
  ...
  void * This;
public:
  explicit UnionAccessInfo(Ctx ctx, isl_union_access_info *That) : ctx(ctx), This((void *)That) {}
  explicit UnionAccessInfo(Ctx ctx, void *That) : ctx(ctx), This(That) {}
  const Ctx &Context() const { return ctx; }
  isl_union_access_info *GetCopy() const;
  ...
  isl_union_access_info *Give();
  /// \brief unwrap the stored isl object.
  /// \return a the wrapped isl object.
  isl_union_access_info *Get() const;
...
public:
  ...
  UnionAccessInfo asUnionAccessInfo() const;
